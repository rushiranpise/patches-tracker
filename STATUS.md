...
| Crime Radar | `com.newsbreak.crimeradar` | `26.28.0` | `26.28.0` |  | NO_UPDATE |  |
...
| Fitbod | `com.fitbod.fitbod` | `8.25.0-2` | `8.25.0-2` |  | NO_UPDATE |  |
...
| Google Photos | `com.google.android.apps.photos` | `7.83.0.943371825` | `7.84.0.949657053` | `52052132` | PATCHED |  |
...
| JEFIT | `je.fit` | `17.2.8` | `17.2.8` |  | NO_UPDATE |  |
...
| nzb360 | `com.kevinforeman.nzb360` | `23.5` | `24` | `522` | PATCHED |  |
...
| PictureThis - Plant Identifier | `cn.danatech.xingseus` | `5.30.0` | `5.30.0` |  | NO_UPDATE |  |
| Pixel Habit Tracker | `com.pixel.al.pixelhabittracker` | `2.1.2` | `2.1.4` |  | SKIPPED_KNOWN_BROKEN |  |
...
| SkinSort | `com.skinsort` | `1.22` | `1.22` |  | NO_UPDATE |  |
...
| Subway Now | `io.goodservice.theweekendest` | `1.2.8` | `1.2.10` | `81` | PATCHED |  |
...
| Toxly | `com.mindful.code.studio.toxly.scanner` | `1.16.6` | `1.17.8` | `78` | FAILED | fingerprint |
...
[!] FlareSolverr status 'error' for https://apkpure.com/inure-app-manager/app.simple.inure.play/downloading/107.1.0
[!] FlareSolverr attempt 1/3 failed for: https://apkpure.com/inure-app-manager/app.simple.inure.play/downloading/107.1.0
[+] FlareSolverr GET attempt 2/3: https://apkpure.com/inure-app-manager/app.simple.inure.play/downloading/107.1.0
...
````text
      ...
      "method_suggestion": {
        "old_method": "Lcin;->n()Z",
        "new_method": "Lcin;-><init>(Lrkm;Ljava/lang/Object;Z)V",
        "score": 0.0,
        "confidence": "none",
    ...
    },
    {
      ...
      "method_suggestion": {
        "old_method": "Lbqr;->g()Z",
        "new_method": "Lbqr;-><init>(Ljava/lang/String;)V",
        "score": 0.0,
        "confidence": "none",
        "reason": "proto=False strings=0 invokes=0 literals=0 margin=0.0"
      }
...
<details><summary>1Tap Cleaner log excerpt</summary>

````text
tcher.Patcher$invoke$1.invoke(Patcher.kt)
	at kotlinx.coroutines.flow.SafeFlow.collectSafely(Builders.kt:57)
	at kotlinx.coroutines.flow.AbstractFlow.collect(Flow.kt:226)
	at app.morphe.cli.command.PatchCommand$call$3$3$1.invokeSuspend(PatchCommand.kt:794)
	at kotlin.coroutines.jvm.internal.BaseContinuationImpl.resumeWith(ContinuationImpl.kt:34)
...
me": "<init>",
      ...
      "missing_strings": [],
      "method_suggestion": {
        "old_method": "Lg80;-><init>(Landroid/content/Context;Lbw1;)V",
        "new_method": "Lg80;-><init>(Ljava/lang/Object;)V",
        "score": 20.705882352941178,
        "confidence": "low",
        "reason": "proto=False strings=0 invokes=1 literals=0 margin=18.2"
      }
    },
    {
    ...
    },
    {
      ...
      "missing_strings": [],
      "method_suggestion": {
        "old_method": "Lg80;->d(Ljava/util/List;)V",
        "new_method": "Lg80;->equals(Ljava/lang/Object;)Z",
...
<details><summary>UDisc log excerpt</summary>

````text
 [],
      "method_suggestion": {
        "old_method": "Lcom/udisc/android/application/UDiscApplication;->onCreate()V",
        "new_method": "Lcom/udisc/android/application/UDiscApplication;->onCreate()V",
        "score": 999.0,
        "confidence": "exact",
        "reason": "same name and proto"
      }
    ...
    {
      "file": "/home/runner/work/patches-tracker/patches-tracker/.work/fingerprint-analysis-source/udisc/patches/src/main/kotlin/app/template/patches/udisc/Fingerprints.kt",
      "line": 27,
      "kind": "Fingerprint",
      "old_class": "Lcom/udisc/android/billing/b;",
      "new_class": "Lcom/udisc/android/billing/b;",
      "class_confidence": "exact",
      "method_name": "a",
      "status": "ok",
      "missing_strings": [],
      "method_suggestion": {
        "old_method": "Lcom/udisc/android/billing/b;->a(La70/b;Ljava/util/List;)V",
        "new_method": "Lcom/udisc/android/billing/b;->a(Ld70/b;Ljava/util/List;)V",
        "score": 53.457142857142856,
        "confidence": "medium",
        "reason": "proto=False strings=1 invokes=8 literals=3 margin=53.5"
      }
    },
    {
      "file": "/home/runner/work/patches-tracker/patches-tracker/.work/fingerprint-analysis-source/udisc/patches/src/main/kotlin/app/template/patches/udisc/Fingerprints.kt",
      ...
      "missing_strings": [],
      "method_suggestion": {
        "old_method": "Lvy/n0;-><init>(ILcom/udisc/kmp/account/Account$Subscription$Platform;Lcom/udisc/kmp/account/Account$Subscription$Status;Ljava/lang/String;)V",
        "new_method": "Lvy/n0;->serializer()Lvb0/a;",
        "score": 0.0,
        "confidence": "none",
        "reason": "proto=False strings=0 invokes=0 literals=0 margin=0.0"
      }
