...
| Amazon India | `in.amazon.mShop.android.shopping` | `32.15.0.300` | `32.16.2.300` | `1243222206` | PATCHED |  |
| Amazon Shopping | `com.amazon.mShop.android.shopping` | `32.13.2.100` | `32.13.2.100` |  | NO_UPDATE |  |
| AmoledPix | `com.androholic.amoledpix` | `7.3` | `8.5` | `93` | FAILED | fingerprint |
| Ampere | `com.gombosdev.ampere` | `v4.37.0` | `v4.37.0` |  | NO_UPDATE |  |
| Android Developer Verifier | `com.google.android.verifier` | `1.0.958871038` | `1.0.958871038` |  | NO_UPDATE |  |
| AndroPods | `pro.vitalii.andropods` | `1.5.28` | `1.5.30` | `86` | PATCHED |  |
| AnExplorer | `dev.dworks.apps.anexplorer` | `6.0.6` | `6.0.6` |  | NO_UPDATE |  |
...
| Aviate | `me.highest.aviate` | `1.1.0-beta.1` | `1.2.2 (1)` |  | FAILED | download |
| Awake | `com.mk.awake` | `1.10.3` | `1.10.3` |  | NO_UPDATE |  |
| Battery Guru | `com.paget96.batteryguru` | `2.5.0.7` | `2.5.0.7` |  | NO_UPDATE |  |
| Battery Guru | `com.paget96.batteryguru` | `2.5.0.7` | `2.5.0.7` |  | NO_UPDATE |  |
| BatteryPods | `com.sumyapplications.bluetooth.earphone` | `7.52` | `7.70` | `7700` | FAILED | signing |
...
| Crime Radar | `com.newsbreak.crimeradar` | `26.33.1` | `26.35.0` | `26350002` | PATCHED |  |
...
| DramaBox | `com.storymatrix.drama` | `5.8.1` | `6.6.0` |  | SKIPPED_KNOWN_BROKEN |  |
| Zutobi | `com.driverlicenseapp` | `4.5.78` | `4.5.79` |  | SKIPPED_KNOWN_BROKEN |  |
...
| Inure App Manager | `app.simple.inure.play` | `build107.2.1` | `build107.2.1` |  | NO_UPDATE |  |
| Inure App Manager (GitHub) | `app.simple.inure` | `build107.2.1` | `build107.2.1` |  | NO_UPDATE |  |
| JEFIT | `je.fit` | `17.4.0` | `17.4.1` | `2077` | PATCHED |  |
| Kahoot! | `no.mobitroll.kahoot.android` | `6.6.7` | `6.7.4` | `3342` | FAILED | fingerprint |
...
| Network Guru | `com.paget96.netspeedindicator` | `2.0` | `2.0` |  | NO_UPDATE |  |
| NewsBreak | `com.particlenews.newsbreak` | `26.35.0` | `26.35.0` |  | NO_UPDATE |  |
...
| Nova Launcher | `com.teslacoilsw.launcher` | `8.8.8` | `89000 (8.9.0)` |  | FAILED | download |
| NYT Games | `com.nytimes.crossword` | `6.39.0` | `6.39.0` |  | NO_UPDATE |  |
| nzb360 | `com.kevinforeman.nzb360` | `24.4.1` | `24.4.1` |  | NO_UPDATE |  |
| OBD Android | `ai.metaverselabs.obdandroid` | `4.9` | `4.9` |  | NO_UPDATE |  |
| Octi | `eu.darken.octi` | `1.2.1-rc0` | `1.2.1-rc0` |  | NO_UPDATE |  |
| Octopi Launcher | `com.otp.octopilauncher` | `1.88` | `1.88` |  | NO_UPDATE |  |
...
| Photo Editor | `com.iudesk.android.photo.editor` | `13.6` | `13.6` |  | NO_UPDATE |  |
| Pialytic | `verbosus.pialytic` | `1.3.1` | `1.3.1` |  | NO_UPDATE |  |
| PicsArt | `com.picsart.studio` | `30.6.4` | `30.6.4` |  | NO_UPDATE |  |
| Picture Mushroom | `com.glority.picturemushroom` | `2.9.31` | `2.9.31` |  | NO_UPDATE |  |
| PictureThis | `cn.danatech.xingseus` | `5.34.0` | `5.34.0` |  | NO_UPDATE |  |
| pillo | `xyz.rtrvr.pillo` | `0.6.18` | `0.6.19` |  | FAILED | download |
...
| RecipeBro | `com.recipebro.cookingbuddy` | `1.7.21` | `26.8.6` | `1642` | FAILED | fingerprint |
| Reddit | `com.reddit.frontpage` | `2026.34.0` | `2026.35.0` | `2635001` | PATCHED |  |
...
| Snipd | `ai.topicfinder.podcastdiscovery` | `4.1.19` | `4.1.19` |  | NO_UPDATE |  |
...
00.019 I: [MERGE] Extracting to: /home/runner/work/patches-tracker/patches-tracker/.work/apkmirror-installer/tmp_958f468f
...
````text
[apkcombo 1.2.2 (1)] [+] FlareSolverr GET attempt 1/3: https://apkcombo.com/search/me.highest.aviate/download
[+] FlareSolverr OK: https://apkcombo.com/search/me.highest.aviate/download (title=Aviate: Flight Companion APK (Android App) - Free Download)
...
Caused by: java.lang.IllegalStateException: Mismatch between override type and Method return type
	...
	at app.morphe.patcher.patch.Patch.execute(Patch.kt:117)
	at app.morphe.patcher.patch.BytecodePatch.execute$morphe_patcher(Patch.kt:259)
...
````text
[apkcombo 4.24.0] [+] FlareSolverr GET attempt 1/3: https://apkcombo.com/search/com.dubox.drive/download
[+] FlareSolverr OK: https://apkcombo.com/search/com.dubox.drive/download (title=Terabox APK (Android App) - Free Download)
[!] APKCombo attempt 1/3 did not show a download link for com.dubox.drive 4.24.0 (bytes=0)
[!] APKCombo attempt 2/3 did not show a download link for com.dubox.drive 4.24.0 (bytes=0)
[!] APKCombo attempt 3/3 did not show a download link for com.dubox.drive 4.24.0 (bytes=0)
[-] Could not find APK link on APKCombo

[gplay 4.24.0] [+] Downloading from Google Play: com.dubox.drive
[+] FlareSolverr detected at http://localhost:8191/v1
[+] Step 1: Getting dispenser credentials...
[!] Direct request blocked (403), trying FlareSolverr...
[!] FlareSolverr failed for https://auroraoss.com/api/auth: 500 Server Error: Internal Server Error for url: http://localhost:8191/v1
...
[-] Error: 403 Client Error: Forbidden for url: https://auroraoss.com/api/auth
{"success": false, "error": "403 Client Error: Forbidden for url: https://auroraoss.com/api/auth"}
[-] Google Play helper failed for com.dubox.drive
...
SEVERE: Patching aborted: FAILED: Unlock Subscription 
...
<details><summary>Lose Weight App for Women log excerpt</summary>

````text
[apkcombo] [+] FlareSolverr GET attempt 1/3: https://apkcombo.com/search/loseweightapp.loseweightappforwomen.womenworkoutathome/download
[+] FlareSolverr OK: https://apkcombo.com/search/loseweightapp.loseweightappforwomen.womenworkoutathome/download (title=Lose Weight App for Women APK (Android App) - Free Download)
...
<details><summary>Money Manager log excerpt</summary>

````text
[apkcombo] [+] FlareSolverr GET attempt 1/3: https://apkcombo.com/search/com.glgjing.money.manager.bookkeeping.meow/download
[+] FlareSolverr OK: https://apkcombo.com/search/com.glgjing.money.manager.bookkeeping.meow/download (title=com.glgjing.money.manager.bookkeeping.meow APK - Download (Android))
...
<details><summary>pillo log excerpt</summary>

````text
[apkcombo 0.6.19] [+] FlareSolverr GET attempt 1/3: https://apkcombo.com/search/xyz.rtrvr.pillo/download
...
````text
[apkmirror 15.5.0] [+] FlareSolverr GET attempt 1/3: https://www.apkmirror.com/apk/truebill/truebill/
...
[+] FlareSolverr GET attempt 1/3: https://www.apkmirror.com/apk/truebill/truebill/rocket-money---bills--budgets-15-5-0-release/
[+] FlareSolverr OK: https://www.apkmirror.com/apk/truebill/truebill/rocket-money---bills--budgets-15-5-0-release/ (title=Rocket Money - Bills &amp; Budgets 15.5.0 APK Download by Rocket Money - Bills &amp; Budgets - APKMirror)
[+] APKMirror release page: https://www.apkmirror.com/apk/truebill/truebill/rocket-money---bills--budgets-15-5-0-release/
[-] Could not find APKMirror variant for version=15.5.0 arch=all dpi=nodpi anydpi auto

[gplay 15.5.0] [+] Downloading from Google Play: com.truebill
[+] FlareSolverr detected at http://localhost:8191/v1
[+] Step 1: Getting dispenser credentials...
[!] Direct request blocked (403), trying FlareSolverr...
[!] FlareSolverr failed for https://auroraoss.com/api/auth: 500 Server Error: Internal Server Error for url: http://localhost:8191/v1
...
SEVERE: Patching aborted: FAILED: Unlock Plus 
...
SEVERE: Patching aborted: FAILED: Downloads 
