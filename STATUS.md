...
| --- | --- | --- | --- | --- | --- | --- |
| Cube ACR | `com.catalinagroup.callrecorder` | `2.4.281` | `2.4.281` |  | OK |  |
| Unimote | `sensustech.universal.tv.remote.control` | `1.8.1` | `1.8.1` |  | OK |  |
| Citizen | `sp0n.citizen` | `0.1298.0` | `0.1300.0` | `1134` | OK |  |
| Case Tracker | `com.saldous.casetracker` | `5.5.2` | `5.5.3` | `1052` | OK |  |
| 1.1.1.1 | `com.cloudflare.onedotonedotonedotone` | `6.38.7` | `6.38.7` |  | OK |  |
| Crime Radar | `com.newsbreak.crimeradar` | `26.23.2` | `26.23.2` |  | OK |  |
| Splitwise | `com.Splitwise.SplitwiseMobile` | `26.6.3` | `26.7.1` | `948` | OK |  |
...
| KillApps | `com.tafayor.killall` | `1.57.9` | `1.57.9` |  | OK |  |
...
| Proton VPN | `ch.protonvpn.android` | `5.19.16.0` | `5.19.16.0` |  | OK |  |
| NetShare | `kha.prog.mikrotik` | `277` | `277` |  | OK |  |
...
| Cashew | `com.budget.tracker_app` | `6.5.9` | `6.6.11` | `510` | OK |  |
...
| MovieBox | `com.community.oneroom` | `3.0.16.0709.03` | `3.0.16.0709.03` |  | OK |  |
| MovieBox (India) | `com.community.mbox.in` | `3.0.16.0707.03` | `latest` |  | FAILED | version_resolve |
| MovieBox TV | `com.community.mbox.tv` | `1.1.4.0710.03` | `3.0.16.0709.03` | `50020116` | OK |  |
...
| UDisc | `com.regasoftware.udisc` | `24.2.1` | `24.2.3` | `9935` | FAILED | fingerprint |
...
| Inmigreat | `com.changayaf.inmigreat` | `2.2.83` | `2.3.4` | `683` | OK |  |
...
| pkge | `net.pkge.pkge` | `19.0.13` | `19.0.13` |  | OK |  |
| SpotAngels | `com.spotangels.android` | `15.2.2` | `15.2.2` |  | OK |  |
| TurboScan | `com.piksoft.turboscan.free` | `1.7.3` | `1.7.3` |  | OK |  |
...
| Pocket Casts | `au.com.shiftyjelly.pocketcasts` | `8.14` | `8.14` |  | OK |  |
| Sticker Maker | `com.marsvard.stickermakerforwhatsapp` | `1.0.10-5` | `1.0.10-5` |  | OK |  |
...
| Fitbod | `com.fitbod.fitbod` | `8.24.0-1` | `8.24.1-0` | `10824100` | OK |  |
...
| Carousell | `com.thecarousell.Carousell` | `2.461.8` | `2.462.7` | `10793` | FAILED | fingerprint |
...
| Ace Ex File Manager | `com.ace.ex.file.manager` | `1.6.0.4` | `1.6.0.4` |  | OK |  |
| RS File Manager | `com.rs.explorer.filemanager` | `2.3.0.4` | `2.3.0.4` |  | OK |  |
| Strava | `com.strava` | `471.11` | `471.11` |  | OK |  |
| KineMaster | `com.nexstreaming.app.kinemasterfree` | `8.1.13.36552.GP` | `latest` |  | FAILED | version_resolve |
| BuzzCast | `com.guochao.faceshow` | `3.2.80` | `3.2.80` |  | OK |  |
| Lark Player | `com.dywx.larkplayer` | `2026.9.6` | `2026.9.6` |  | OK |  |
| Uptodown App Store | `com.uptodown` | `7.34` | `7.34` |  | OK |  |
...
| PLAYit | `com.playit.videoplayer` | `2.7.50.12` | `2.7.50.12` |  | OK |  |
| Pocket Bard | `com.MojoFilterMediaLLC.RPGSoundSystem` | `3.1.15` | `3.1.16` | `234` | OK |  |
| NYT Games | `com.nytimes.crossword` | `6.33.0` | `6.33.1` | `6426456` | OK |  |
| komoot | `de.komoot.android` | `2026.28.2` | `2026.28.2` |  | OK |  |
| MEGA | `mega.privacy.android.app` | `16.9(261881039)(3c7e30562a)` | `16.9(261881039)(3c7e30562a)` |  | OK |  |
| Dailyhunt | `com.eterno` | `33.5.4` | `33.5.4` |  | OK |  |
...
[+] HTTP GET: https://camscanner-pdf-creator.en.uptodown.com/android/download/1188436272 -> -
